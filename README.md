...
1. How would you describe acessibility on the web to someone new to programming?
   ...
   -Acessibility lets anyone with a disability be able to access the website and navigate it in their favor. Example, zooming in on the text to be read easier, or a text to speech.

2. Talk about 3 different things you can do to ensure your website is accessible.

   -Making sure that the website works, what you select brings you to where you want to.'
   -There is the option of the Text to Speech application.'
   -Lastly that the website itself is clear and easily readable with a font adjustment option to zoom in.

3. How would you explain the concept of a variable to someone new to programming?

   -Variables hold a "value" or piece of information within the code.

4. What is the purpose of using functions in code?

   -Using functions in code reduces the amount of errors you can make, as well as makes the code easier to read in the long run.
